...
colp_growth<- loadRData(here("06 - Appendix Analysis", "01 - Alternative fixed growth rate","Parameter_Values","CP_growth_pe.Rdata"))

#### Model Fits - Block 1 growth ####


#### 0. Competition #####
##### Search Grid #####
comp.pre_sg <- expand.grid(r2_log = c(-5, -3, -1, -0.5), 
...
set.seed(67808)
comp.sim_grid <- comp.pre_sg[sample(comp.pre_sg$strtpt, 98, replace = F), ]
...
# Run Grid #
colp_para_comp_g1r_pe <- NA # name of file where parallel runs will be save

(t0<-Sys.time()) # timer
mcoptions <- list(preschedule=FALSE)

colp_para_comp_g1r_pe <- foreach(i = 1:nrow(comp.sim_grid),
                                  .combine = 'rbind',
                                  ...
                                  .errorhandling = "pass") %dopar%
  {
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.lv,
                 ...
                 start = list(alpha11 = comp.sim_grid$alpha11[[i]],
                 ...
                 fixed = list(r1_log = colp_growth[colp_growth$Group == "G1" & colp_growth$Term == "r1_log" ,]$Estimate) 
      ) 
      
      if(fit@details$convergence==0) {
        comp.sim_grid$alpha11.est[i] <- fit@coef[[1]]
        comp.sim_grid$alpha12.est[i] <- fit@coef[[2]]
        
        comp.sim_grid$r2_log.est[i] <- fit@coef[[3]]
        comp.sim_grid$alpha22.est[i] <- fit@coef[[4]]
        comp.sim_grid$alpha21.est[i] <- fit@coef[[5]]
        
        comp.sim_grid$sigma.est [i] <- fit@coef[[6]]
        comp.sim_grid$sigma2.est [i] <- fit@coef[[7]]
...
colp_para_comp_g1r_pe %>% arrange(BIC)
save(colp_para_comp_g1r_pe, file = "CP_compg1r_pe.RData")

###### Best Model #####
CP_LV_pe_g1r <- colp_para_comp_g1r_pe
(CP_comp_PECs_g1r <- CP_LV_pe_g1r %>% 
    filter(converge == 0) %>% 
    filter(BIC <= min(CP_LV_pe_g1r$BIC, na.rm = T)+2)) #check for similarity in parameter estimates within 2 AIC of min

min_comp <- CP_comp_PECs_g1r %>% filter(BIC == min(CP_comp_PECs_g1r$BIC, na.rm = T))

if(nrow(min_comp)>1){
  min_comp <- CP_comp_PECs_g1r %>% filter(strtpt %in% sample(filter(CP_comp_PECs_g1r, BIC <= min(CP_comp_PECs_g1r$BIC, na.rm = T)+0.1)$strtpt,1))
}

CPcomp_pe_mod_g1r =  mle2(minuslogl = nll.odeint.lv,
                      method= "Nelder-Mead",
                      control = list(maxit = 5000),
                      
                      start = list(alpha11 = min_comp$alpha11.est,
...
save(CPcomp_pe_mod_g1r, file = "colp_para_comp_fit_g1r.RData")
comp_tidy<-tidy(CPcomp_pe_mod_g1r)

(nrow(CP_comp_PECs_g1r)/nrow(colp_para_comp_g1r_pe %>% filter(converge == 0))) * 100 # percent of starting combinations within 2 AIC that 
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.t2.a1.h1.lv,
                 ...
                 fixed = list(m = mort,
                              ...
                              r1_log = coef(CPcomp_pe_mod_g1r)[1], 
                              alpha11 = coef(CPcomp_pe_mod_g1r)[2],
                              alpha12 = coef(CPcomp_pe_mod_g1r)[3],
                              r2_log = coef(CPcomp_pe_mod_g1r)[4], 
                              alpha22 = coef(CPcomp_pe_mod_g1r)[5],
                              alpha21 = coef(CPcomp_pe_mod_g1r)[6]) 
      )
...
save(CP_t2_fixLV_pe, file = "CP_t2_fixLV_g1r_pe.RData")
...
save(CP_min_T2_fixLV_mod, file = "CP_T2_fixLV_g1r_mod.Rdata")
...
save(CP_t2.a12_fixLV_pe, file = "CP_t2.a12_fixLV_g1r_pe.RData")
...
save(CP_min_t2.a12_fixLV_mod, file = "CP_t2.a12_fixLV_g1r_mod.Rdata")
...
save(CP_t2.h12_fixLV_pe, file = "CP_t2.h12_fixLV_g1r_pe.RData")
...
save(CP_min_t2.h12_fixLV_mod, file = "CP_t2.h12_fixLV_g1r_mod.Rdata")
...
save(CP_t2.a12.h12_fixLV_pe, file = "CP_t2.a12.h12_fixLV_g1r_pe.RData")
...
save(CP_min_t2.a12.h12_fixLV_mod, file = "CP_t2.a12.h12_fixLV_g1r_mod.Rdata")
...
save(CP_t2.vv_fixLV_pe, file = "CP_t2.vv_fixLV_g1r_pe.RData")
...
save(CP_min_t2.vv_fixLV_mod, file = "CP_t2.vv_fixLV_g1r_mod.Rdata")
...
save(CP_t2.vv.h12_fixLV_pe, file = "CP_t2.vv.h12_fixLV_g1r_pe.RData")
...
save(CP_min_t2.vv.h12_fixLV_mod, file = "CP_t2.vv.h12_fixLV_g1r_mod.Rdata")
...
save(CP_t2.cm_fixLV_pe, file = "CP_t2.cm_fixLV_g1r_pe.RData")
...
save(CP_min_t2.cm_fixLV_mod, file = "CP_t2.cm_fixLV_g1r_mod.Rdata")
...
save(CP_t3_fixLV_pe, file = "CP_t3_fixLV_g1r_pe.RData")
...
save(CP_min_t3_fixLV_mod, file = "CP_t3_fixLV_g1r_mod.Rdata")
...
save(CP_t3.a12_fixLV_pe, file = "CP_t3.a12_fixLV_g1r_pe.RData")
...
save(CP_min_t3.a12_fixLV_mod, file = "CP_t3.a12_fixLV_g1r_mod.Rdata")
...
save(CP_t3.h12_fixLV_pe, file = "CP_t3.h12_fixLV_g1r_pe.RData")
...
save(CP_min_t3.h12_fixLV_mod, file = "CP_t3.h12_fixLV_g1r_mod.Rdata")
...
save(CP_t3.a12.h12_fixLV_pe, file = "CP_t3.a12.h12_fixLV_g1r_pe.RData")
...
save(CP_min_t3.a12.h12_fixLV_mod, file = "CP_t3.a12.h12_fixLV_g1r_mod.Rdata")
...
save(CP_t3.vv_fixLV_pe, file = "CP_t3.vv_fixLV_g1r_pe.RData")
...
save(CP_min_t3.vv_fixLV_mod, file = "CP_t3.vv_fixLV_g1r_mod.Rdata")
...
save(CP_t3.cm_fixLV_pe, file = "CP_t3.cm_fixLV_g1r_pe.RData")
...
save(CP_min_t3.cm_fixLV_mod, file = "CP_t3.cm_fixLV_g1r_mod.Rdata")
...
#### BIC Table ####
CP_gr1_BIC<-as.data.frame(BIC(CP_min_T2_fixLV_mod,
...
CP_gr1_BIC$model<-seq(1, nrow(CP_gr1_BIC), by =1); CP_gr1_BIC$dBIC<-round(CP_gr1_BIC$BIC-min(CP_gr1_BIC$BIC, na.rm = T),1)

CP_gr1_BIC %>% arrange(CP_gr1_BIC$BIC)
...
# Run Grid #
colp_para_comp_g2r_pe <- NA # name of file where parallel runs will be save

(t0<-Sys.time()) # timer
mcoptions <- list(preschedule=FALSE)

colp_para_comp_g2r_pe <- foreach(i = 1:nrow(comp.sim_grid),
                                 .combine = 'rbind',
                                 .options.multicore = mcoptions,
                                 .packages = c('bbmle', 'odeintr', 'tidyverse', 'R.utils'),
                                 .errorhandling = "pass") %dopar%
  {
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.lv,
                 ...
                 fixed = list(r1_log = colp_growth[colp_growth$Group == "G2" & colp_growth$Term == "r1_log" ,]$Estimate) 
      ) 
...
colp_para_comp_g2r_pe %>% arrange(BIC)
save(colp_para_comp_g2r_pe, file = "CP_compg2r_pe.RData")

###### Best Model #####
CP_LV_pe_g2r <- colp_para_comp_g2r_pe
(CP_comp_PECs_g2r <- CP_LV_pe_g2r %>% 
    filter(converge == 0) %>% 
    filter(BIC <= min(CP_LV_pe_g2r$BIC, na.rm = T)+2)) #check for similarity in parameter estimates within 2 AIC of min

min_comp <- CP_comp_PECs_g2r %>% filter(BIC == min(CP_comp_PECs_g2r$BIC, na.rm = T))

if(nrow(min_comp)>1){
  min_comp <- CP_comp_PECs_g2r %>% filter(strtpt %in% sample(filter(CP_comp_PECs_g2r, BIC <= min(CP_comp_PECs_g2r$BIC, na.rm = T)+0.1)$strtpt,1))
}

CPcomp_pe_mod_g2r =  mle2(minuslogl = nll.odeint.lv,
                          method= "Nelder-Mead",
                          control = list(maxit = 5000),
...
save(CPcomp_pe_mod_g2r, file = "colp_para_comp_fit.RData")
comp_tidy<-tidy(CPcomp_pe_mod_g2r)

(nrow(CP_comp_PECs_g2r)/nrow(colp_para_comp_g2r_pe %>% filter(converge == 0))) * 100 # percent of starting combinations within 2 AIC that 
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.t2.a1.h1.lv,
                 ...
                 fixed = list(m = mort,
                              ...
                              r1_log = coef(CPcomp_pe_mod_g2r)[1], 
                              alpha11 = coef(CPcomp_pe_mod_g2r)[2],
                              alpha12 = coef(CPcomp_pe_mod_g2r)[3],
                              r2_log = coef(CPcomp_pe_mod_g2r)[4], 
                              alpha22 = coef(CPcomp_pe_mod_g2r)[5],
                              alpha21 = coef(CPcomp_pe_mod_g2r)[6]) 
      )
...
save(CP_t2_fixLV_pe, file = "CP_t2_fixLV_g2r_pe.RData")
...
save(CP_min_T2_fixLV_mod, file = "CP_T2_fixLV_g2r_mod.Rdata")
tidy(CP_min_T2_fixLV_mod)
...
CP_t2.a12_fixLV_pe %>% arrange(BIC)
save(CP_t2.a12_fixLV_pe, file = "CP_t2.a12_fixLV_g2r_pe.RData")
...
save(CP_min_t2.a12_fixLV_mod, file = "CP_t2.a12_fixLV_g2r_mod.Rdata")
tidy(CP_min_t2.a12_fixLV_mod)
...
save(CP_t2.h12_fixLV_pe, file = "CP_t2.h12_fixLV_g2r_pe.RData")
...
save(CP_min_t2.h12_fixLV_mod, file = "CP_t2.h12_fixLV_g2r_mod.Rdata")
tidy(CP_min_t2.h12_fixLV_mod)
...
save(CP_t2.a12.h12_fixLV_pe, file = "CP_t2.a12.h12_fixLV_g2r_pe.RData")
...
save(CP_min_t2.a12.h12_fixLV_mod, file = "CP_t2.a12.h12_fixLV_g2r_mod.Rdata")
tidy(CP_min_t2.a12.h12_fixLV_mod)
...
save(CP_t2.vv_fixLV_pe, file = "CP_t2.vv_fixLV_g2r_pe.RData")
...
save(CP_min_t2.vv_fixLV_mod, file = "CP_t2.vv_fixLV_g2r_mod.Rdata")
tidy(CP_min_t2.vv_fixLV_mod)
...
save(CP_t2.vv.h12_fixLV_pe, file = "CP_t2.vv.h12_fixLV_g2r_pe.RData")
...
save(CP_min_t2.vv.h12_fixLV_mod, file = "CP_t2.vv.h12_fixLV_g2r_mod.Rdata")
tidy(CP_min_t2.vv.h12_fixLV_mod)
...
save(CP_t2.cm_fixLV_pe, file = "CP_t2.cm_fixLV_g2r_pe.RData")
...
save(CP_min_t2.cm_fixLV_mod, file = "CP_t2.cm_fixLV_g2r_mod.Rdata")
tidy(CP_min_t2.cm_fixLV_mod)
...
save(CP_t3_fixLV_pe, file = "CP_t3_fixLV_g2r_pe.RData")
...
save(CP_min_t3_fixLV_mod, file = "CP_t3_fixLV_g2r_mod.Rdata")
tidy(CP_min_t3_fixLV_mod)
...
CP_t3.a12_fixLV_pe %>% arrange(BIC)
save(CP_t3.a12_fixLV_pe, file = "CP_t3.a12_fixLV_g2r_pe.RData")
...
save(CP_min_t3.a12_fixLV_mod, file = "CP_t3.a12_fixLV_g2r_mod.Rdata")
tidy(CP_min_t3.a12_fixLV_mod)
...
save(CP_t3.h12_fixLV_pe, file = "CP_t3.h12_fixLV_g2r_pe.RData")
...
save(CP_min_t3.h12_fixLV_mod, file = "CP_t3.h12_fixLV_g2r_mod.Rdata")
tidy(CP_min_t3.h12_fixLV_mod)
...
save(CP_t3.a12.h12_fixLV_pe, file = "CP_t3.a12.h12_fixLV_g2r_pe.RData")
...
save(CP_min_t3.a12.h12_fixLV_mod, file = "CP_t3.a12.h12_fixLV_g2r_mod.Rdata")
tidy(CP_min_t3.a12.h12_fixLV_mod)
...
save(CP_t3.vv_fixLV_pe, file = "CP_t3.vv_fixLV_g2r_pe.RData")
...
save(CP_min_t3.vv_fixLV_mod, file = "CP_t3.vv_fixLV_g2r_mod.Rdata")
tidy(CP_min_t3.vv_fixLV_mod)
...
save(CP_t3.cm_fixLV_pe, file = "CP_t3.cm_fixLV_g2r_pe.RData")
...
save(CP_min_t3.cm_fixLV_mod, file = "CP_t3.cm_fixLV_g2r_mod.Rdata")
tidy(CP_min_t3.cm_fixLV_mod)
...
#### BIC Table ####
CP_gr2_BIC<-as.data.frame(BIC(CP_min_T2_fixLV_mod,
                          CP_min_t2.a12_fixLV_mod,
                          CP_min_t2.h12_fixLV_mod,
                          CP_min_t2.a12.h12_fixLV_mod,
                          CP_min_t2.vv_fixLV_mod,
                          ...
                          CP_min_t3.vv_fixLV_mod,
                          CP_min_t3.cm_fixLV_mod))
CP_gr2_BIC$model<-seq(1, nrow(CP_gr2_BIC), by =1); CP_gr2_BIC$dBIC<-round(CP_gr2_BIC$BIC-min(CP_gr2_BIC$BIC, na.rm = T),1)

CP_gr2_BIC %>% arrange(BIC)
