...
dexio_growth<- loadRData(here("06 - Appendix Analysis", "01 - Alternative fixed growth rate","Parameter_Values","DP_growth_pe.Rdata")) # Data
...
# Run Grid #
dexio_para_comp_g1r_pe <- NA # name of file where parallel runs will be save

(t0<-Sys.time()) # timer
mcoptions <- list(preschedule=FALSE)

dexio_para_comp_g1r_pe <- foreach(i = 1:nrow(comp.sim_grid),
                                 .combine = 'rbind',
                                 ...
                                 .errorhandling = "pass") %dopar%
  {
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.lv,
                 ...
                 fixed = list(r1_log = dexio_growth[dexio_growth$Group == "G1" & dexio_growth$Term == "r1_log" ,]$D_Estimate) 
      ) 
...
dexio_para_comp_g1r_pe %>% arrange(BIC)
save(dexio_para_comp_g1r_pe, file = "DP_compg1r_pe.RData")

###### Best Model #####
DP_LV_pe_g1r <- dexio_para_comp_g1r_pe
(DP_comp_PECs_g1r <- DP_LV_pe_g1r %>% 
    filter(converge == 0) %>% 
    filter(BIC <= min(DP_LV_pe_g1r$BIC, na.rm = T)+2)) #check for similarity in parameter estimates within 2 AIC of min

min_comp <- DP_comp_PECs_g1r %>% filter(BIC == min(DP_comp_PECs_g1r$BIC, na.rm = T))

if(nrow(min_comp)>1){
  min_comp <- DP_comp_PECs_g1r %>% filter(strtpt %in% sample(filter(DP_comp_PECs_g1r, BIC <= min(DP_comp_PECs_g1r$BIC, na.rm = T)+0.1)$strtpt,1))
}

DPcomp_pe_mod_g1r =  mle2(minuslogl = nll.odeint.lv,
                          method= "Nelder-Mead",
...
save(DPcomp_pe_mod_g1r, file = "dexio_para_comp_fit_gr1.RData")
comp_tidy<-tidy(DPcomp_pe_mod_g1r)

(nrow(DP_comp_PECs_g1r)/nrow(dexio_para_comp_g1r_pe %>% filter(converge == 0))) * 100 # percent of starting combinations within 2 AIC that 
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.t2.a1.h1.lv,
                 ...
                 fixed = list(m = mort,
                              ...
                              r1_log = coef(DPcomp_pe_mod_g1r)[1], 
                              alpha11 = coef(DPcomp_pe_mod_g1r)[2],
                              alpha12 = coef(DPcomp_pe_mod_g1r)[3],
                              r2_log = coef(DPcomp_pe_mod_g1r)[4], 
                              alpha22 = coef(DPcomp_pe_mod_g1r)[5],
                              alpha21 = coef(DPcomp_pe_mod_g1r)[6]) 
      )
...
save(DP_t2_fixLV_pe, file = "DP_t2_fixLV_g1r_pe.RData")
...
save(DP_min_T2_fixLV_mod, file = "DP_T2_fixLV_g1r_mod.Rdata")
...
save(DP_t2.a12_fixLV_pe, file = "DP_t2.a12_fixLV_g1r_pe.RData")
...
save(DP_min_t2.a12_fixLV_mod, file = "DP_t2.a12_fixLV_g1r_mod.Rdata")
...
save(DP_t2.h12_fixLV_pe, file = "DP_t2.h12_fixLV_g1r_pe.RData")
...
save(DP_min_t2.h12_fixLV_mod, file = "DP_t2.h12_fixLV_g1r_mod.Rdata")
...
save(DP_t2.a12.h12_fixLV_pe, file = "DP_t2.a12.h12_fixLV_g1r_pe.RData")
...
save(DP_min_t2.a12.h12_fixLV_mod, file = "DP_t2.a12.h12_fixLV_g1r_mod.Rdata")
...
save(DP_t2.vv_fixLV_pe, file = "DP_t2.vv_fixLV_g1r_pe.RData")
...
save(DP_min_t2.vv_fixLV_mod, file = "DP_t2.vv_fixLV_g1r_mod.Rdata")
...
save(DP_t2.vv.h12_fixLV_pe, file = "DP_t2.vv.h12_fixLV_g1r_pe.RData")
...
save(DP_min_t2.vv.h12_fixLV_mod, file = "DP_t2.vv.h12_fixLV_g1r_mod.Rdata")
...
save(DP_t2.cm_fixLV_pe, file = "DP_t2.cm_fixLV_g1r_pe.RData")
...
save(DP_min_t2.cm_fixLV_mod, file = "DP_t2.cm_fixLV_g1r_mod.Rdata")
...
save(DP_t3_fixLV_pe, file = "DP_t3_fixLV_g1r_pe.RData")
...
save(DP_min_t3_fixLV_mod, file = "DP_t3_fixLV_g1r_mod.Rdata")
...
save(DP_t3.a12_fixLV_pe, file = "DP_t3.a12_fixLV_g1r_pe.RData")
...
save(DP_min_t3.a12_fixLV_mod, file = "DP_t3.a12_fixLV_g1r_mod.Rdata")
...
save(DP_t3.h12_fixLV_pe, file = "DP_t3.h12_fixLV_g1r_pe.RData")
...
save(DP_min_t3.h12_fixLV_mod, file = "DP_t3.h12_fixLV_g1r_mod.Rdata")
...
save(DP_t3.a12.h12_fixLV_pe, file = "DP_t3.a12.h12_fixLV_g1r_pe.RData")
...
save(DP_min_t3.a12.h12_fixLV_mod, file = "DP_t3.a12.h12_fixLV_g1r_mod.Rdata")
...
save(DP_t3.vv_fixLV_pe, file = "DP_t3.vv_fixLV_g1r_pe.RData")

###### Best Model #####
(DP_t3.vv_PECs <- DP_t3.vv_fixLV_pe %>% 
   filter(converge == 0) %>% 
   filter(BIC <= min(DP_t3.vv_fixLV_pe$BIC, na.rm = T)+2)) #check for similarity in parameter estimates within 2 AIC of min
...
save(DP_min_t3.vv_fixLV_mod, file = "DP_t3.vv_fixLV_g1r_mod.Rdata")
...
save(DP_t3.cm_fixLV_pe, file = "DP_t3.cm_fixLV_g1r_pe.RData")
...
save(DP_min_t3.cm_fixLV_mod, file = "DP_t3.cm_fixLV_g1r_mod.Rdata")
...
#### BIC Table ####
DP_gr1_BIC<-as.data.frame(BIC(DP_min_T2_fixLV_mod,
...
DP_gr1_BIC$model<-seq(1, nrow(DP_gr1_BIC), by =1); DP_gr1_BIC$dBIC<-round(DP_gr1_BIC$BIC-min(DP_gr1_BIC$BIC, na.rm = T),1)

DP_gr1_BIC %>% arrange(BIC)
...
set.seed(67808)
comp.sim_grid <- comp.pre_sg[sample(comp.pre_sg$strtpt, 7, replace = F), ]
...
# Run Grid #
dexio_para_comp_g2r_pe <- NA # name of file where parallel runs will be save

(t0<-Sys.time()) # timer
mcoptions <- list(preschedule=FALSE)

dexio_para_comp_g2r_pe <- foreach(i = 1:nrow(comp.sim_grid),
                                 .combine = 'rbind',
                                 .options.multicore = mcoptions,
                                 .packages = c('bbmle', 'odeintr', 'tidyverse', 'R.utils'),
                                 .errorhandling = "pass") %dopar%
  {
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.lv,
                 ...
                 fixed = list(r1_log = dexio_growth[dexio_growth$Group == "G2" & dexio_growth$Term == "r1_log" ,]$D_Estimate) 
      ) 
      ...
      if(fit@details$convergence==0) {
        ...
        comp.sim_grid$sigma.est [i] <- fit@coef[[5]]
        comp.sim_grid$sigma2.est [i] <- fit@coef[[6]]
...
dexio_para_comp_g2r_pe %>% arrange(BIC)
save(dexio_para_comp_g2r_pe, file = "DP_compg2r_pe.RData")

###### Best Model #####
DP_LV_pe_g2r <- dexio_para_comp_g2r_pe
(DP_comp_PECs_g2r <- DP_LV_pe_g2r %>% 
    filter(converge == 0) %>% 
    filter(BIC <= min(DP_LV_pe_g2r$BIC, na.rm = T)+2)) #check for similarity in parameter estimates within 2 AIC of min

min_comp <- DP_comp_PECs_g2r %>% filter(BIC == min(DP_comp_PECs_g2r$BIC, na.rm = T))

if(nrow(min_comp)>1){
  min_comp <- DP_comp_PECs_g2r %>% filter(strtpt %in% sample(filter(DP_comp_PECs_g2r, BIC <= min(DP_comp_PECs_g2r$BIC, na.rm = T)+0.1)$strtpt,1))
}

DPcomp_pe_mod_g2r =  mle2(minuslogl = nll.odeint.lv,
                          method= "Nelder-Mead",
                          control = list(maxit = 5000),
...
#### STOPPED HERE ####
# the best model has a negative sigma (i.e. negative variation and the model cannot be evaluated --> need to address - can we add a logic statement to the function --> see R&R)


save(DPcomp_pe_mod_g2r, file = "dexio_para_comp_fit_g2r.RData")
comp_tidy<-tidy(DPcomp_pe_mod_g2r)

(nrow(DP_comp_PECs_g2r)/nrow(dexio_para_comp_g2r_pe %>% filter(converge == 0))) * 100 # percent of starting combinations within 2 AIC that 
    ...
    r<-tryCatch({ 
      ...
      fit = mle2(minuslogl = nll.odeint.t2.a1.h1.lv,
                 ...
                 fixed = list(m = mort,
                              ...
                              r1_log = coef(DPcomp_pe_mod_g2r)[1], 
                              alpha11 = coef(DPcomp_pe_mod_g2r)[2],
                              alpha12 = coef(DPcomp_pe_mod_g2r)[3],
                              r2_log = coef(DPcomp_pe_mod_g2r)[4], 
                              alpha22 = coef(DPcomp_pe_mod_g2r)[5],
                              alpha21 = coef(DPcomp_pe_mod_g2r)[6]) 
      )
...
#save(DP_t2_fixLV_pe, file = "DP_t2_fixLV_g2r_pe.RData")
...
#save(DP_min_T2_fixLV_mod, file = "DP_T2_fixLV_g2r_mod.Rdata")
tidy(DP_min_T2_fixLV_mod)
...
DP_t2.a12_fixLV_pe %>% arrange(BIC)
#save(DP_t2.a12_fixLV_pe, file = "DP_t2.a12_fixLV_g2r_pe.RData")
...
#save(DP_min_t2.a12_fixLV_mod, file = "DP_t2.a12_fixLV_g2r_mod.Rdata")
tidy(DP_min_t2.a12_fixLV_mod)
...
#save(DP_t2.h12_fixLV_pe, file = "DP_t2.h12_fixLV_g2r_pe.RData")
...
#save(DP_min_t2.h12_fixLV_mod, file = "DP_t2.h12_fixLV_g2r_mod.Rdata")
tidy(DP_min_t2.h12_fixLV_mod)
...
#save(DP_t2.a12.h12_fixLV_pe, file = "DP_t2.a12.h12_fixLV_g2r_pe.RData")
...
#save(DP_min_t2.a12.h12_fixLV_mod, file = "DP_t2.a12.h12_fixLV_g2r_mod.Rdata")
tidy(DP_min_t2.a12.h12_fixLV_mod)
...
#save(DP_t2.vv_fixLV_pe, file = "DP_t2.vv_fixLV_g2r_pe.RData")
...
#save(DP_min_t2.vv_fixLV_mod, file = "DP_t2.vv_fixLV_g2r_mod.Rdata")
tidy(DP_min_t2.vv_fixLV_mod)
...
#save(DP_t2.vv.h12_fixLV_pe, file = "DP_t2.vv.h12_fixLV_g2r_pe.RData")
...
#save(DP_min_t2.vv.h12_fixLV_mod, file = "DP_t2.vv.h12_fixLV_g2r_mod.Rdata")
tidy(DP_min_t2.vv.h12_fixLV_mod)
...
#save(DP_t2.cm_fixLV_pe, file = "DP_t2.cm_fixLV_g2r_pe.RData")
...
#save(DP_min_t2.cm_fixLV_mod, file = "DP_t2.cm_fixLV_g2r_mod.Rdata")
tidy(DP_min_t2.cm_fixLV_mod)
...
#save(DP_t3_fixLV_pe, file = "DP_t3_fixLV_g2r_pe.RData")
...
#save(DP_min_t3_fixLV_mod, file = "DP_t3_fixLV_g2r_mod.Rdata")
tidy(DP_min_t3_fixLV_mod)
...
DP_t3.a12_fixLV_pe %>% arrange(BIC)
#save(DP_t3.a12_fixLV_pe, file = "DP_t3.a12_fixLV_g2r_pe.RData")
...
#save(DP_min_t3.a12_fixLV_mod, file = "DP_t3.a12_fixLV_g2r_mod.Rdata")
tidy(DP_min_t3.a12_fixLV_mod)
...
#save(DP_t3.h12_fixLV_pe, file = "DP_t3.h12_fixLV_g2r_pe.RData")
...
#save(DP_min_t3.h12_fixLV_mod, file = "DP_t3.h12_fixLV_g2r_mod.Rdata")
tidy(DP_min_t3.h12_fixLV_mod)
...
#save(DP_t3.a12.h12_fixLV_pe, file = "DP_t3.a12.h12_fixLV_g2r_pe.RData")
...
#save(DP_min_t3.a12.h12_fixLV_mod, file = "DP_t3.a12.h12_fixLV_g2r_mod.Rdata")
tidy(DP_min_t3.a12.h12_fixLV_mod)
...
#save(DP_t3.vv_fixLV_pe, file = "DP_t3.vv_fixLV_g2r_pe.RData")
...
#save(DP_min_t3.vv_fixLV_mod, file = "DP_t3.vv_fixLV_g2r_mod.Rdata")
tidy(DP_min_t3.vv_fixLV_mod)
...
#save(DP_t3.cm_fixLV_pe, file = "DP_t3.cm_fixLV_g2r_pe.RData")
...
#save(DP_min_t3.cm_fixLV_mod, file = "DP_t3.cm_fixLV_g2r_mod.Rdata")
tidy(DP_min_t3.cm_fixLV_mod)
...
#### BIC Table ####
DP_gr2_BIC<-as.data.frame(BIC(DP_min_T2_fixLV_mod,
                              DP_min_t2.a12_fixLV_mod,
                              DP_min_t2.h12_fixLV_mod,
                              DP_min_t2.a12.h12_fixLV_mod,
                              DP_min_t2.vv_fixLV_mod,
                              ...
                              DP_min_t3.vv_fixLV_mod,
                              DP_min_t3.cm_fixLV_mod))
DP_gr2_BIC$model<-seq(1, nrow(DP_gr2_BIC), by =1); DP_gr2_BIC$dBIC<-round(DP_gr2_BIC$BIC-BIC(DP_min_t2.a12_fixLV_mod),1)

DP_gr2_BIC %>% arrange(BIC)